...
import { BookOpen, FileText, CheckCircle, TrendingUp, User, LogOut, Settings, RefreshCw, Info, Mail, Phone, Calendar, GraduationCap } from "lucide-react";
...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    console.log('Student Dashboard - user data:', user);
    if (user?.id) {
      console.log('Student Dashboard - fetching data for user ID:', user.id);
      fetchDashboardData();
    }
  }, [user?.id]);
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const userResponse = await studentService.getCurrentUser();
      ...
      setStats({
        totalSubjects: apiStats.totalSubjects || 0,
        attendancePercentage: apiStats.averageAttendance || 0,
        averageGrade: apiStats.averageGrade || 0,
        averageAttendance: apiStats.averageAttendance || 0,
        recentResults: apiStats.recentResults || 0
      });
    } catch (error: any) {
        ...
        <main className="flex-1">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Welcome, {user?.profile?.fullName || user?.profile?.firstName || 'Student'}
                </p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <Avatar className="h-12 w-12">
                          <AvatarImage src={userData.profile?.avatar || "/placeholder.svg"} alt="Student" />
                          <AvatarFallback className="bg-blue-100 text-blue-600 font-semibold">
                            {userData.profile?.fullName?.charAt(0) || 'S'}
                          </AvatarFallback>
                        </Avatar>
                        <div className="flex-1">
                          <h3 className="font-semibold text-lg">{userData.profile?.fullName || 'Student'}</h3>
                      ...
                      <div className="pt-3 border-t">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            <span>Last exam: 1 week ago</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              {/* Student Panel Instructions Card */}
              <Card className="overflow-hidden">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">View personal info, academic stats, and panel guide</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Download notes, assignments, and study resources</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Track daily attendance and subject-wise records</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">View exam scores, grades, and performance analytics</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Ask questions and communicate with professors</p>
                        </div>
                      </div>
                    </div>
